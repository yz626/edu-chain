...
func newDepartment(db *gorm.DB, opts ...gen.DOOption) department {
	...
	_department.OrganizationID = field.NewString(tableName, "organization_id")
	_department.ParentID = field.NewString(tableName, "parent_id")
	_department.Name = field.NewString(tableName, "name")
	_department.Code = field.NewString(tableName, "code")
	_department.Type = field.NewInt32(tableName, "type")
	_department.Description = field.NewString(tableName, "description")
	_department.LeaderID = field.NewString(tableName, "leader_id")
	_department.SortOrder = field.NewInt64(tableName, "sort_order")
	_department.IsActive = field.NewBool(tableName, "is_active")
	_department.Level = field.NewInt64(tableName, "level")
	_department.Path = field.NewString(tableName, "path")
	_department.ExtraData = field.NewString(tableName, "extra_data")
...
type department struct {
	...
	ALL            field.Asterisk
	ID             field.String // 部门ID (UUID)
	OrganizationID field.String // 所属组织ID
	ParentID       field.String // 上级部门ID
	Name           field.String // 部门名称
	Code           field.String // 部门代码
	Type           field.Int32  // 部门类型: 1-职能部门, 2-教学部门, 3-行政部门, 4-其他
	Description    field.String // 部门描述
	LeaderID       field.String // 负责人ID
	SortOrder      field.Int64  // 排序序号
	IsActive       field.Bool   // 是否启用
	Level          field.Int64  // 部门层级
...
func (d *department) fillFieldMap() {
	...
	d.fieldMap["leader_id"] = d.LeaderID
