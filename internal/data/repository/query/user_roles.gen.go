...
func newUserRole(db *gorm.DB, opts ...gen.DOOption) userRole {
	...
	_userRole.ID = field.NewString(tableName, "id")
	_userRole.UserID = field.NewString(tableName, "user_id")
	_userRole.RoleID = field.NewString(tableName, "role_id")
	_userRole.GrantedAt = field.NewTime(tableName, "granted_at")
	_userRole.GrantedBy = field.NewString(tableName, "granted_by")
	_userRole.ExpiresAt = field.NewTime(tableName, "expires_at")
	_userRole.IsActive = field.NewBool(tableName, "is_active")
	_userRole.Remark = field.NewString(tableName, "remark")
...
type userRole struct {
	...
	GrantedAt field.Time   // 授权时间
	GrantedBy field.String // 授权人ID
...
func (u *userRole) updateTableName(table string) *userRole {
	...
	u.GrantedAt = field.NewTime(table, "granted_at")
	u.GrantedBy = field.NewString(table, "granted_by")
...
func (u *userRole) fillFieldMap() {
	...
	u.fieldMap["granted_at"] = u.GrantedAt
	u.fieldMap["granted_by"] = u.GrantedBy
