...
func newRolePermission(db *gorm.DB, opts ...gen.DOOption) rolePermission {
	...
	_rolePermission.ID = field.NewString(tableName, "id")
	...
	_rolePermission.IsGranted = field.NewBool(tableName, "is_granted")
	_rolePermission.Conditions = field.NewString(tableName, "conditions")
...
type rolePermission struct {
	...
	IsGranted    field.Bool   // 是否授予
	Conditions   field.String // 授权条件
...
func (r *rolePermission) updateTableName(table string) *rolePermission {
	...
	r.IsGranted = field.NewBool(table, "is_granted")
...
func (r *rolePermission) fillFieldMap() {
	...
	r.fieldMap["is_granted"] = r.IsGranted
