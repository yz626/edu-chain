...
-- 优化: 移除冗余字段(retry_count, last_retry_at), 合并blockchain_certificates
...
CREATE TABLE `blockchain_transactions` (
    ...
    `cert_hash` VARCHAR(64) DEFAULT NULL COMMENT '证书数据哈希',
    `owner_address` VARCHAR(128) DEFAULT NULL COMMENT '所有者区块链地址',
    `token_id` VARCHAR(64) DEFAULT NULL COMMENT 'NFT Token ID',
